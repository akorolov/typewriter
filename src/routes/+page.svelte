		...
		<div class="mb-8 text-center">
			...
			<div class="mt-2 flex items-center justify-center gap-4">
				<a
					...
					class="inline-flex items-center gap-1.5 text-sm text-base-content/40 hover:text-base-content/70 transition-colors"
				>
				...
				<a href="/help" class="inline-flex items-center gap-1 text-sm text-base-content/40 hover:text-base-content/70 transition-colors">
